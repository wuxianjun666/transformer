...
```
conda create -n anchor python=3.8
...
pip3 install -i https://pypi.douban.com/simple/  torchtext
pip3 install -i https://pypi.douban.com/simple/  spacy
pip3 install -i https://pypi.douban.com/simple/   matplotlib
cd tokenizer/
pip3 install de_core_news_sm-3.2.0.tar.gz 
pip3 install en_core_web_sm-3.2.0.tar.gz 
pip3 install zh_core_web_sm-3.2.0.tar.gz 
```
